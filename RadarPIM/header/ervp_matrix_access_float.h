#ifndef __ERVP_MATRIX_ACCESS_FLOAT_H__
#define __ERVP_MATRIX_ACCESS_FLOAT_H__

static inline float read_matrix_float_element(const ErvpMatrixInfo *matrix, int row_index, int col_index)
{
...
static inline void write_matrix_float_element(const ErvpMatrixInfo *matrix, int row_index, int col_index, float wdata)
{
	void *row_addr = get_row_addr(matrix, row_index);
	switch(matrix->datatype)
	{
