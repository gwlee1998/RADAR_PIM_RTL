...
#define UART_DLM	0x4	/* Out: Divisor Latch High (DLAB=1) */                     
...
#define UART_FCR	0x8	/* Out: FIFO Control Register */                           
				/* (8250 doesn't have FIFO Control Register) */
#define UART_EFR	0x8	/* I/O: Extended Features Register */                      
				/* (DLAB=1, 16C660 only) */                                            
...
#define UART_EN			(0x20)	/* UART enable */
#define UART_TC			(0x24)	/* Transmisster FIFO count */
